...
import com.squareboat.util.Const.Drawable.END
import com.squareboat.util.Const.Drawable.START
...
fun String.ismatchPassword(confirmPass: String): Boolean {
    return this.checkString() == confirmPass
}
