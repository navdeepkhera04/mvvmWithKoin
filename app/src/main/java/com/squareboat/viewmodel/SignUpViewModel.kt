...
class SignUpViewModel(private val dataRepository: AuthorizationRepository, private val userRepository: UserRepository) : ViewModel() {
    ...
    fun hitApiRegisterUser(): LiveData<Event<DataResult<UserSignupModelResponse>>> {

        viewModelScope.launch {
            val response = dataRepository.userRegisterApi(loginData.value!!)
