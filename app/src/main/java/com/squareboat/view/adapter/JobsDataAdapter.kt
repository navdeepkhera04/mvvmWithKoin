...
import com.squareboat.model.pojo.RecruiterDataItem
import com.squareboat.util.RecyclerviewOnClickListener


class JobsDataAdapter(
    var listener: RecyclerviewOnClickListener, private var ItemModelArrayList: List<RecruiterDataItem?>?
) : RecyclerView.Adapter<JobsDataAdapter.ViewHolder>() {
